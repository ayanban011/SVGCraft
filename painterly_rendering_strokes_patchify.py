...
def painter_strokes(target,num_paths,max_width,use_lpips_loss,num_iter,use_blob):
    # Use GPU if available
    pydiffvg.set_use_gpu(torch.cuda.is_available())
    
    perception_loss = ttools.modules.LPIPS().to(pydiffvg.get_device())
    
    #target = torch.from_numpy(skimage.io.imread('/home/abanerjee/Downloads/try1-modified.png')).to(torch.float32) / 255.0
    ...
    #main(args)
#painter_strokes("./laptop_monitor.png",2048,4.0,True,500,False)
